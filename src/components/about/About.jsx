    ...
    <section className="about section" id="about">
        ...
        <div className="about__container container grid">
            ...
            <div className="about__data">
                ...
                <p className="about__description">With extensive experience in both Information Technology and Web Development, I have a high understanding of Front End systems including the use of HTML, CSS and Javascript frameworks as well a few Content Management Systems (EpiServer/Optimizely, Wordpress, and Drupal to name a few).<br/><br/>
