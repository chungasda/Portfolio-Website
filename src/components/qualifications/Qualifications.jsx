          ...
          >
            <div className="qualifications__data">
              <div>
                <h3 className="qualifications__title">
                  ICT50115 Diploma in Information Technology
                </h3>
            ...
            <div className="qualifications__data">
              ...
              <div>
                ...
                <div className="qualifications__calendar">
                  <i className="uil uil-calendar-alt"></i> August 2019 - May
                  2020
                </div>
              </div>
            </div>
            ...
            <div className="qualifications__data">
              <div>
                <h3 className="qualifications__title">
                  Front End Web Developer & IT Support Officer
                </h3>
                <span className="qualifications__subtitle">
                  Australian Institute of Mining & Metallurgy
                </span>
                <div className="qualifications__calendar">
                  <i className="uil uil-calendar-alt"></i> April 2021 - October
                  2022
                </div>
              </div>
